...
const addressesData = JSON.parse(fs.readFileSync('./data/addresses.json', 'utf-8'));
...
app.get('/addresses', (req, res) => {
    res.render('addresses.mustache', addressesData);
});
...
app.post('/submit', (req, res) => {
    ...
    res.render('feedback.mustache', { title: "Оставленный отзыв", data: formattedData})
});
